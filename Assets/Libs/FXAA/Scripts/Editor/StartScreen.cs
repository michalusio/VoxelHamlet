...
namespace AseFxaa
{
	...
	{
		public static readonly string PrefStartUp = "AALastSession" + Application.productName;
		public static readonly string PrefForceUpdate = "AAForceUpdate" + Application.productName;
	}

	public class StartScreen : EditorWindow
	{
		[MenuItem( "Window/FXAA/Start Screen", false, 19 )]
		public static void Init()
		{
			StartScreen window = (StartScreen)GetWindow( typeof( StartScreen ), true, "FXAA Start Screen" );
		...
		public static readonly string BannerInfoURL = "http://amplify.pt/Banner/AAInfo.json";
		public static readonly string PackageRefURL = "http://amplify.pt/Banner/PackageRef.json";

		private static readonly string WikiURL = "http://wiki.amplify.pt/index.php?title=Unity_Products:FXAA";
		...
		private static readonly string StoreURL = "https://assetstore.unity.com/packages/vfx/shaders/fullscreen-camera-effects/fxaa-fast-approximate-anti-aliasing-3590?aid=1011lPwI&pubref=" + RefID;
